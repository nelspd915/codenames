...
const SERVER_URL = "development" === "development" ?
  "http://localhost:8080" :
  "https://bestdotaeu-codenames-backend.herokuapp.com";

const codenamesAppCss = ":host{display:block}codenames-board{width:800px}";

const CodenamesApp = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  revealCellHandler(event) {
  ...
  async connectedCallback() {
    this.socket = lookup(SERVER_URL);
    this.socket.on("updateBoard", (boardData) => {
   ...
   */
  render() {
    return (h(Host, null, h("codenames-board", { boardData: this.boardData })));
  }
};
CodenamesApp.style = codenamesAppCss;

export { CodenamesApp as codenames_app };

//# sourceMappingURL=codenames-app.entry.js.map